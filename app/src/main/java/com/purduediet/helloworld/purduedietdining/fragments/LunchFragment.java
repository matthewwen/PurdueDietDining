...
public class LunchFragment extends Fragment
        implements MainAdapter.MainActivityRecycleActivity,
        RecyclerSectionItemDecoration.OpenDiningActivity,
    ...
    RecyclerSectionItemDecoration sectionItemDecoration; //decorates the recycle view with headings.
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.lunch_rv);
        allItemFood = DataMethod.getLunchTodayOptions(getContext());
